...
import reciclarte.com.br.reciclarte.domain.Rate
import reciclarte.com.br.reciclarte.domain.Empresas


class AllEmpresasListAdapter(
        private val shoesList: List<Empresas>
    ) :
    RecyclerView.Adapter<AllEmpresasListAdapter.ViewHolder>() {
    ...
    inner class ViewHolder( itemView: View ) :
        ...
        private fun setPrice( shoes: Empresas ){
